                            ...
                            <form name="registration_form" id='registration_form' class="form-inline">
                                <div class="row">
                                    <div class="form-group col-xs-6">
                                        ...
                                        <input id="firstname" class="form-control input-group-lg" type="text" name="firstname" title="Enter first name" placeholder="Имя"/>
                                    </div>
                                    <div class="form-group col-xs-6">
                                        <label for="lastname" class="sr-only">Фамилия</label>
                                        <input id="lastname" class="form-control input-group-lg" type="text" name="lastname" title="Enter last name" placeholder="Фамилия"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-xs-12">
                                        <label for="email" class="sr-only">Email</label>
                                        <input id="email" class="form-control input-group-lg" type="text" name="Email" title="Enter Email" placeholder="Ваш Email"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-xs-12">
                                        <label for="password" class="sr-only">Password</label>
                                        <input id="password" class="form-control input-group-lg" type="password" name="password" title="Enter password" placeholder="Пароль"/>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-3 col-xs-6">
                                        ...
                                        <select class="form-control" id="day">
                                            <option value="Day" disabled selected>День</option>
                                            <option>1</option>
                                            <option>2</option>
                                            <option>3</option>
                                            <option>4</option>
                                    ...
                                    <div class="form-group col-sm-3 col-xs-6">
                                        ...
                                        <select class="form-control" id="month">
                                            <option value="month" disabled selected>Мес</option>
                                            <option>Jan</option>
                                            <option>Feb</option>
                                            <option>Mar</option>
                                            <option>Apr</option>
                                    ...
                                    <div class="form-group col-sm-6 col-xs-12">
                                        ...
                                        <select class="form-control" id="year">
                                            <option value="year" disabled selected>Год</option>
                                            <option>2000</option>
                                            <option>2001</option>
                                            <option>2002</option>
                                            <option>2004</option>
                                ...
                                <div class="form-group gender">
                                    <label class="radio-inline">
                                        <input type="radio" name="optradio" checked>Мужик
                                    </label>
                                    <label class="radio-inline">
                                ...
                                <div class="row">
                                    <div class="form-group col-xs-6">
                                        ...
                                        <input id="city" class="form-control input-group-lg reg_name" type="text" name="city" title="Enter city" placeholder="Ваш город"/>
                                    </div>
                                    <div class="form-group col-xs-6">
