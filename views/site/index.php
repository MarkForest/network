        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="intro-texts">
                    ...
                    <p><span class="hidden">Привет Всем! Меня зовут Марченко Анатолий я являюсь автором сети looklike.
                        ...
                        к тебе по другому относятся.<span class="hidden"> Я думаю вы поняли мораль... К чему это все?
