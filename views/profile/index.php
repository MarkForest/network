                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="texts" id="exampleTextarea" cols="60" rows="1" class="form-control" placeholder="Напишите, что пожелаете..."></textarea>
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-12">
                                <div class="tools">
                                    ...
                                    <input class="btn btn-primary pull-right" type="submit" name="addPost" value="Публиковать">
                                </div>
                            </div>
                        </div>
